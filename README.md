...
Instead, changes can be made in `lib.rs`.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGmYW0CYXZlMC43LjJhdIQbgiWOwqb2YKkbqMVrNrCIcPMbhrOdZpcmg20bYiAXpb0OQsdhYvRhcoQbP95UYbyOOXcbymyiOygram8b_FTtvQwrMaQbwag7P0pfc8RhZIODZ2FzaWMtcnNlMC41LjJnYXNpY19yc4JkZGF0YfaCZm1pbmVyc_Y
 [__link0]: https://docs.rs/asic-rs/0.5.2/asic_rs/?search=factory::MinerFactory
 [__link1]: https://docs.rs/asic-rs/0.5.2/asic_rs/?search=factory::MinerFactory
